...
(function () {
  ...
  var baseCredits = [
    ...
    { date: '2018–22', title: 'Lorca & Chekhov', author: 'Scenes', authorEs: 'Escenas', kind: 'theatre', lead: 'Betsabé Qui', leadRole: 'director', venue: 'Pitt Street Theatre · Auckland' }
  ];
  ...
  var factsEn = [
    { k: 'Disciplines', v: 'Theatre · Dance · Ritual · Improvisation' },
    { k: 'Country', v: 'Mexico · Spain · Qatar · New Zealand' },
    { k: 'Languages', v: 'Spanish · English · French' }
  ];
  var factsEs = [
    { k: 'Disciplinas', v: 'Teatro · Danza · Ritual · Improvisación' },
    { k: 'País', v: 'México · España · Qatar · Nueva Zelanda' },
    { k: 'Idiomas', v: 'Español · Inglés · Francés' }
  ];

  var C = {
    en: {
      nav: { about: 'About', work: 'Work', gallery: 'Gallery', contact: 'Contact' },
      hero: { kicker: 'Stage & Movement Artist · México', name: 'Ann Ortega', tagline: 'Actress · Producer', line: 'Ritual, memory, and movement — carried onto the contemporary stage.', cta1: 'Get in touch', cta2: 'Selected work', cta3: 'Download CV', scroll: 'Scroll' },
      ...
      work: { num: '02', title: 'Selected Work', title2: 'On Stage', note: 'Recent stage and movement work. Full résumé on request.', colDate: 'Date', colProd: 'Presentation', colRole: 'Role', colDir: 'Direction', colVenue: 'Venue' },
    ...
    es: {
      ...
      hero: { kicker: 'Artista escénica y de movimiento · México', name: 'Ann Ortega', tagline: 'Actriz · Productora', line: 'Ritualidad, memoria y movimiento — llevadas a la escena contemporánea.', cta1: 'Contacto', cta2: 'Ver trabajo', cta3: 'Descargar CV', scroll: 'Desliza' },
      ...
      work: { num: '02', title: 'En escena', title2: 'En escena', note: 'Trabajo escénico y de movimiento reciente. Currículum completo a solicitud.', colDate: 'Fecha', colProd: 'Presentación', colRole: 'Papel', colDir: 'Dirección', colVenue: 'Espacio' },
      ...
      if (dir === 'A') {
        return '' +
          '<div style="display:grid; grid-template-columns:1fr auto; gap:16px; align-items:baseline; padding:20px 2px; border-bottom:1px solid rgba(239,230,216,.1);">' +
            ...
            '</div>' +
            '<div style="font-size:11px; letter-spacing:.1em; text-transform:uppercase; color:#d6b485; white-space:nowrap;">' + i.y + '</div>' +
          '</div>';
      }
      return '' +
    ...
    var creditRows = credits.map(function (c) {
      return '' +
        '<div data-reveal class="credit-row" style="display:grid; grid-template-columns:90px minmax(240px,1.7fr) 1.3fr 1fr; gap:18px; align-items:baseline; padding:26px 8px; border-bottom:1px solid rgba(239,230,216,.1); transition:background .35s, padding-left .35s;">' +
          '<span style="font-size:12.5px; color:#d6b485; letter-spacing:.04em;">' + c.date + '</span>' +
    ...
    '<div data-dir="A" style="--pad:52px; background:#120d0a; color:#efe6d8; font-family:\'Hanken Grotesk\',system-ui,sans-serif;">' +
      ...
      '<nav id="siteNav" data-variant="A" style="position:fixed; top:0; left:0; right:0; z-index:55; display:flex; align-items:center; justify-content:space-between; padding:24px var(--pad); transition:all .5s ease; border-bottom:1px solid rgba(239,230,216,0);">' +
        ...
        '<div style="display:flex; align-items:center; gap:26px;">' +
          '<div class="nav-links" style="display:flex; align-items:center; gap:32px; font-size:12px; font-weight:600; letter-spacing:.18em; text-transform:uppercase; color:#c7bca9;">' +
            ...
            '<a class="nav-contact" href="#contact" style="padding:8px 18px; border:1px solid rgba(214,180,133,.5); border-radius:100px; color:#ecd4a9; transition:all .3s;">' + t.nav.contact + '</a>' +
          '</div>' +
      ...
      '<header id="top" style="position:relative; height:100vh; min-height:640px; overflow:hidden;">' +
        ...
        '<div style="position:relative; z-index:2; height:100%; max-width:1280px; margin:0 auto; padding:0 var(--pad) 118px; display:flex; flex-direction:column; justify-content:flex-end;">' +
          ...
          '<div data-reveal style="margin-top:16px; font-family:\'Marcellus\',serif; font-style:italic; font-size:clamp(19px,2.2vw,28px); color:#ecd4a9; letter-spacing:.02em;">' + t.hero.tagline + '</div>' +
          ...
          '<div data-reveal style="display:flex; flex-wrap:wrap; gap:14px; margin-top:38px;">' +
            '<a class="cta1" href="#contact" style="display:inline-flex; align-items:center; gap:10px; padding:15px 28px; background:#d6b485; color:#19110b; border-radius:100px; font-size:12.5px; font-weight:600; letter-spacing:.12em; text-transform:uppercase; transition:transform .3s, box-shadow .3s; box-shadow:0 12px 40px -14px rgba(214,180,133,.7);">' + t.hero.cta1 + '</a>' +
            ...
            '<a class="cta2" href="Ann-Ortega-CV.pdf" download style="display:inline-flex; align-items:center; gap:9px; padding:15px 28px; border:1px solid rgba(239,230,216,.28); border-radius:100px; font-size:12.5px; font-weight:600; letter-spacing:.12em; text-transform:uppercase; color:#efe6d8; transition:all .3s;">' + t.hero.cta3 + ' ↓</a>' +
          '</div>' +
        '</div>' +
        '<div style="position:absolute; bottom:28px; left:50%; transform:translateX(-50%); z-index:2; display:flex; flex-direction:column; align-items:center; gap:9px;">' +
          ...
          '<span style="width:1px; height:28px; background:linear-gradient(#d6b485,transparent); animation:floaty 2.4s ease-in-out infinite;"></span>' +
        '</div>' +
      '</header>' +
      ...
      '<section style="border-top:1px solid rgba(239,230,216,.1); border-bottom:1px solid rgba(239,230,216,.1); padding:22px 0; overflow:hidden; background:#0f0b08;">' +
        '<div style="display:flex; width:max-content; animation:marquee 42s linear infinite;">' +
          '<div style="display:flex; align-items:center; gap:46px; padding-right:46px; font-family:\'Marcellus\',serif; font-style:italic; font-size:25px; color:#6f6557; white-space:nowrap;">' + marqueeRow('◇', '#d6b485', '13px') + '</div>' +
          '<div aria-hidden="true" style="display:flex; align-items:center; gap:46px; padding-right:46px; font-family:\'Marcellus\',serif; font-style:italic; font-size:25px; color:#6f6557; white-space:nowrap;">' + marqueeRow('◇', '#d6b485', '13px') + '</div>' +
        '</div>' +
      '</section>' +
      ...
      '<section id="about" data-section="aboutA" style="max-width:1280px; margin:0 auto; padding:138px var(--pad) 118px; display:grid; grid-template-columns:0.9fr 1.1fr; gap:80px; align-items:start;">' +
        ...
        '<div data-reveal>' +
          '<div style="display:flex; align-items:center; gap:14px; margin-bottom:24px;">' +
            '<span style="font-size:12px; letter-spacing:.3em; text-transform:uppercase; color:#d6b485;">' + t.about.num + ' — ' + t.about.title + '</span>' +
          ...
          '<div style="display:flex; flex-direction:column; gap:18px; font-size:16.5px; line-height:1.78; color:#b9ab98; max-width:580px;">' +
            ...
            '<p>' + t.about.p2 + '</p>' +
          '</div>' +
          '<blockquote style="margin-top:34px; padding-left:22px; border-left:2px solid #d6b485; font-family:\'Marcellus\',serif; font-style:italic; font-size:21px; line-height:1.5; color:#ecd4a9; max-width:600px;">' + t.about.statement + '</blockquote>' +
          '<div style="display:grid; grid-template-columns:1fr; gap:1px; margin-top:42px; background:rgba(239,230,216,.12); border:1px solid rgba(239,230,216,.12);">' + factCells + '</div>' +
        '</div>' +
      '</section>' +
      ...
      '<section id="work" style="border-top:1px solid rgba(239,230,216,.1); background:#0f0b08;">' +
        '<div style="max-width:1280px; margin:0 auto; padding:118px var(--pad);">' +
          '<div data-reveal style="display:flex; align-items:flex-end; justify-content:space-between; gap:24px; margin-bottom:50px;">' +
            '<div>' +
              '<div style="font-size:12px; letter-spacing:.3em; text-transform:uppercase; color:#d6b485; margin-bottom:16px;">' + t.work.num + ' — ' + t.work.title + '</div>' +
      ...
      '<section data-section="dualcol" style="max-width:1280px; margin:0 auto; padding:118px var(--pad); display:grid; grid-template-columns:1fr 1fr; gap:72px;">' +
        '<div data-reveal>' +
          '<div style="display:flex; align-items:center; gap:14px; margin-bottom:30px;">' +
            '<span style="font-size:12px; letter-spacing:.3em; text-transform:uppercase; color:#d6b485;">' + t.training.num + ' — ' + t.training.title + '</span>' +
            '<span style="flex:1; height:1px; background:rgba(239,230,216,.14);"></span>' +
          '</div>' + listRows(training, 'A') +
        '</div>' +
        '<div data-reveal>' +
          '<div style="display:flex; align-items:center; gap:14px; margin-bottom:30px;">' +
            '<span style="font-size:12px; letter-spacing:.3em; text-transform:uppercase; color:#d6b485;">' + t.awards.num + ' — ' + t.awards.title + '</span>' +
            '<span style="flex:1; height:1px; background:rgba(239,230,216,.14);"></span>' +
      ...
      '<section id="gallery" style="max-width:1340px; margin:0 auto; padding:30px var(--pad) 118px;">' +
        '<div data-reveal style="display:flex; align-items:flex-end; justify-content:space-between; gap:24px; margin-bottom:48px;">' +
          '<div>' +
            '<div style="font-size:12px; letter-spacing:.3em; text-transform:uppercase; color:#d6b485; margin-bottom:16px;">' + t.gallery.num + ' — ' + t.gallery.title + '</div>' +
      ...
      '<section id="contact" style="position:relative; border-top:1px solid rgba(239,230,216,.1); background:#0f0b08; overflow:hidden;">' +
        ...
        '<div style="position:relative; z-index:2; max-width:1180px; margin:0 auto; padding:128px var(--pad); text-align:center;">' +
          '<div data-reveal style="font-size:12px; letter-spacing:.3em; text-transform:uppercase; color:#d6b485; margin-bottom:24px;">' + t.contact.num + ' — ' + t.contact.title + '</div>' +
          ...
          '<a data-reveal class="contact-email" href="mailto:annortega@pm.me" style="display:inline-block; font-family:\'Marcellus\',serif; font-style:italic; font-size:clamp(26px,3.4vw,42px); color:#ecd4a9; border-bottom:1px solid rgba(214,180,133,.4); padding-bottom:6px; transition:all .3s;">annortega@pm.me</a>' +
